...
export async function GET() {
  ...
  const weeklyBlocks = [
    ...
    },
    {
      ...
      corridor_zone: 'Zone 4 (km 54.0 to 60.0)',
      day_of_week: 'Friday',
      time_window: '01:30 - 04:15',
      track_id: 'Chengalpattu - Platform Line 2',
    ...
    },
    {
      ...
      corridor_zone: 'Zone 1 (km 0.0 to 6.0)',
      day_of_week: 'Sunday',
      time_window: '00:45 - 03:30',
      track_id: 'Chennai Beach - Down Main Line',
      allocated_hours: 2.75,
